...
export default function StudioTopBar({ onToggleSidebar }: Props) {
  ...
  return (
    <div className="studio-topbar">
      ...
      <button title="Switch project" style={{ background:"none", border:"none", cursor:"pointer", display:"flex", alignItems:"center", gap:5, padding:"4px 8px", borderRadius:5, color:"var(--text-muted)", fontSize:12, fontFamily:"'DM Sans',sans-serif", fontWeight:450, letterSpacing:"-0.01em", transition:"color 0.15s ease" }}
      ...
      <button onClick={() => navigate("/studio/work")}
        ...
        style={{ background:"var(--text-primary)", color:"var(--bg-primary)", border:"none", cursor:"pointer", fontSize:12, fontWeight:600, padding:"7px 14px", borderRadius:6, fontFamily:"'DM Sans',sans-serif", display:"flex", alignItems:"center", gap:6, transition:"opacity 0.15s", letterSpacing:"-0.01em" }}
