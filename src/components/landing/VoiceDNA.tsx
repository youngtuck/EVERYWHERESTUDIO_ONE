    ...
    <section style={{ padding:"100px 32px", background:"var(--bg)", borderTop:"1px solid var(--line)" }}>
      <div style={{ maxWidth:1160, margin:"0 auto", display:"grid", gridTemplateColumns:"1fr 1fr", gap:100, alignItems:"start" }} className="vdna-g">
        <div>
          ...
          <p style={{ fontSize:16, lineHeight:1.82, color:"var(--fg-2)", fontFamily:"'Montserrat', sans-serif", fontWeight:300, marginBottom:14 }}>
          ...
          <p style={{ fontSize:14, lineHeight:1.78, color:"var(--fg-3)", fontFamily:"'Montserrat', sans-serif", fontWeight:300 }}>
        ...
        <div>
          ...
          <div style={{ padding:"28px 32px", background:"var(--surface)", border:"1px solid var(--line)", borderRadius:12, marginBottom:24, boxShadow:"var(--shadow-sm)" }}>
            ...
            <div style={{ display:"flex", alignItems:"baseline", gap:8 }}>
              <span style={{ fontFamily:"'Montserrat', sans-serif", fontSize:72, fontWeight:400, color:"#F5C642", letterSpacing:"-3px", lineHeight:1 }}>94.7</span>
              <span style={{ fontSize:13, color:"var(--fg-3)", fontFamily:"'Montserrat', sans-serif", fontWeight:300 }}>/100 · ↑ 2.3 this week</span>
            </div>
          </div>
          {/* Layers */}
          {LAYERS.map((l,i) => (
            <div key={i} style={{ marginBottom:20 }}>
              <div style={{ display:"flex", justifyContent:"space-between", marginBottom:8 }}>
                <span style={{ fontSize:13, fontWeight:400, color:"var(--fg)", fontFamily:"'Montserrat', sans-serif" }}>{l.name} Layer</span>
                <span style={{ fontSize:13, fontWeight:500, color:"#F5C642", fontFamily:"'Montserrat', sans-serif" }}>{l.pct}%</span>
              </div>
              ...
              <p style={{ fontSize:13, color:"var(--fg-3)", fontFamily:"'Montserrat', sans-serif", fontWeight:300 }}>{l.note}</p>
            </div>
          ))}
        </div>
      </div>
