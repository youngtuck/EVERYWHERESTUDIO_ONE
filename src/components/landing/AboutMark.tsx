      ...
      <div style={{ maxWidth:860, margin:"0 auto" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"auto 1fr", gap:48, alignItems:"start" }} className="mark-g">
          <div style={{ width:72, height:72, borderRadius:12, background:"#111110", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0, border:"1px solid rgba(245,198,66,0.22)" }}>
            <span style={{ fontFamily:"'Montserrat', sans-serif", fontSize:22, fontWeight:400, color:"#F5C642", letterSpacing:"-0.5px" }}>MS</span>
          </div>
          <div>
            <h2 style={{ fontFamily:"'Montserrat', sans-serif", fontSize:"clamp(22px,2.5vw,34px)", fontWeight:400, color:"var(--fg)", marginBottom:20, letterSpacing:"-0.3px" }}>Mark Sylvester</h2>
            <blockquote style={{ borderLeft:"2px solid #F5C642", paddingLeft:24, marginBottom:20 }}>
              <p style={{ fontSize:17, lineHeight:1.82, color:"var(--fg)", fontFamily:"'Montserrat', sans-serif", fontWeight:400, fontStyle:"italic" }}>
