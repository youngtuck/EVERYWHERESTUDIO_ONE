    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          pointerEvents: "none",
          background: "radial-gradient(ellipse 80% 60% at 50% 20%, rgba(245,198,66,0.08) 0%, transparent 50%), radial-gradient(ellipse 60% 40% at 80% 80%, rgba(74,144,217,0.06) 0%, transparent 50%), radial-gradient(ellipse 70% 50% at 30% 60%, rgba(200,169,110,0.04) 0%, transparent 45%)",
        }}
      />
      <style>{`
      ...
      <div style={{ width: "100%", maxWidth: 400, position: "relative", zIndex: 1 }}>
        ...
        <div
          style={{
            ...
            boxShadow: "0 8px 48px rgba(0,0,0,0.3), 0 2px 6px rgba(0,0,0,0.15), inset 0 0 30px rgba(255,255,255,0.04), inset -1px -1px 0.5px rgba(255,255,255,0.08), inset 1px 1px 0.5px rgba(255,255,255,0.05)",
          }}
        >
          ...
          <div style={{ display: "flex", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
            <button
              ...
              style={{
                ...
                backdropFilter: mode === "signin" ? "blur(8px)" : "none",
                WebkitBackdropFilter: mode === "signin" ? "blur(8px)" : "none",
                border: "none",
            ...
            <button
              ...
              style={{
                ...
                backdropFilter: mode === "signup" ? "blur(8px)" : "none",
                WebkitBackdropFilter: mode === "signup" ? "blur(8px)" : "none",
                border: "none",
          ...
          >
            ...
            >
              ...
              {mode === "signup" && (
                <>
                  <button
                    ...
                    style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, background: "rgba(27,38,59,0.4)", backdropFilter: "blur(8px)", WebkitBackdropFilter: "blur(8px)", borderRadius: 10, border: "1px solid rgba(255,255,255,0.1)", color: "#ffffff", padding: "11px 14px", cursor: "pointer", marginBottom: 0 }}
                  >
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.background = "rgba(245,198,66,0.3)"; e.currentTarget.style.borderColor = "rgba(245,198,66,0.45)"; e.currentTarget.style.boxShadow = "0 4px 20px rgba(245,198,66,0.15)"; }}
                onMouseLeave={e => { e.currentTarget.style.background = "rgba(245,198,66,0.2)"; e.currentTarget.style.borderColor = "rgba(245,198,66,0.3)"; e.currentTarget.style.boxShadow = "none"; }}
              >
                {mode === "signin" ? "Sign In" : "Join the Studio"}
              </button>
              {submitError && (
            ...
            {mode === "signin" && (
              <>
                ...
                <button
                  type="button"
                  onClick={handleGoogleSignIn}
                  style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, background: "rgba(27,38,59,0.4)", backdropFilter: "blur(8px)", WebkitBackdropFilter: "blur(8px)", borderRadius: 10, border: "1px solid rgba(255,255,255,0.1)", color: "#ffffff", padding: "11px 14px", cursor: "pointer" }}
                >
                  <svg width="16" height="16" viewBox="0 0 24 24"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg>
